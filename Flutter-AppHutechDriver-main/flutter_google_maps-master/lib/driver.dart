...
class _DriverPageState extends State<DriverPage> {
  ...
  Map<String, List<String>> statusGroups = {
    'Chưa nhận': ['Chưa nhận'],
    'Đã nhận': ['Đã nhận đơn','Đang chạy', 'Hoàn thành'], // Add other statuses you want to include
  };
 ...
 List<Trip> get filteredTrips {
  return selectedStatus == 'Chưa nhận'
      ...
      : trips.where((trip) => trip.status != 'Chưa nhận' && trip.driverId == driverId).toList();
}
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  child: ListTile(
                    ...
                    title: Text('Chuyến đi lúc $formattedDateTime', style: TextStyle(fontSize: 20)),
                    subtitle: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('$startLocation - $endLocation, style: TextStyle(fontSize: 20)'),
